...
<head>
    ...
    <title>Maçons RP-Confederações e Potências</title>
    <link rel="stylesheet" href="css/confederacao.css">
</head>
...
<body style="display: flex; justify-content: center; background-color: #353dda9a; padding: 40px 0;">
    <div style="width: 80%;height: 80% ;background-color: white;">
        ...
        <h1>Confederações</h1>
        <img style="width: 20%;" src="Imagens/Logo-CMI-300x300.png" alt="">
        <h1>CMI</h1>
        <a class="jorge" href="https://www.cmi1947.org/">Confederação Maçônica Interamericana</a>
        <p>Os Grandes Orientes confederados à COMAB, após aprovação em assembleia específica, fazem parte da Zona V da
            CMI.</p>

        <div class="gob">
            <img src="Imagens/ugle-logo-300x150.jpg" alt="">
            <h1>GLUI</h1>
            <a class="jorge" href="http://www.gob.org.br/">Grande Loja Unida da Inglaterra</a>
        </div>

        <div class="gob">
            <img style="width: 37%;" src="Imagens/cmsb.jpg" alt="">
            <h1>CMSB</h1>
            <a class="jorge" href="http://www.cmsb.org.br/">Confederação da Maçonaria Simbólica do Brasil</a>
        </div>


        <img style="width: 20%;" src="Imagens/gob-logo-150x150.png" alt="">
        <h1>GOB</h1>
        <a class="jorge" href="http://www.gob.org.br/">Grande Oriente do Brasil</a>
